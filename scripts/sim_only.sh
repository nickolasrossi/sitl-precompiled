...
# ardupilot SITL script adapted to run just the simulator without mavproxy
# from Scavlink project - https://github.com/nickolasrossi/scavlink
...
# apply random home offset if specified
if [ $OFFSET -gt 0 ]; then
